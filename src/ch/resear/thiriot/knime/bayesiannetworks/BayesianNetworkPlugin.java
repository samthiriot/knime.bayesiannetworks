 ...
 */
public class BayesianNetworkPlugin extends Plugin {
    // The shared instance.
    private static BayesianNetworkPlugin plugin;

    /**
     * The constructor.
     */
    public BayesianNetworkPlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BayesianNetworkPlugin getDefault() {
        return plugin;
    }
